...
class stockStatus:
    ...
    'BESTBUY5': ['https://www.bestbuy.com/site/hot-wheels-worldwide-basic-car-styles-may-vary/6151804.p?skuId=6151804',
                '.add-to-cart-button', 
                'Add to Cart',
                'Test Product'],
    }
    ...
    def DiscordWebhook():
        webhook = DiscordWebhook(url='https://discord.com/api/webhooks/872724550679404555/zkQPGdLbTSldYfgyQ4Jj2W_lyDM1DHRqMBrgCKfWkR3BRVygftNv8Y4q9_ukWTd3gOHp', username="Best Buy Monitor")

        embed = DiscordEmbed(title='In Stock Alert', description='Product In Stock', color='03b2f8')
        embed.set_author(name='Vader Monitors', url='', icon_url='')
        embed.set_footer(text='Powered By VaderIO')
        embed.set_timestamp()
